        ...
        <div className='flex justify-between items-center self-stretch'>
          <div className='flex w-full justify-center items-center gap-4'>
            <Button className='flex p-2 rounded-full bg-primary-500/25 hover:bg-primary-500/50 transition-colors duration-200 group'>
              <Instagram size={24} className='text-primary-500 group-hover:text-white transition-colors duration-200' />
            </Button>
            <Button className='flex p-2 rounded-full bg-primary-500/25 hover:bg-primary-500/50 transition-colors duration-200 group'>
              <Facebook size={24} className='text-primary-500 group-hover:text-white transition-colors duration-200' />
            </Button>
            <Button className='flex p-2 rounded-full bg-primary-500/25 hover:bg-primary-500/50 transition-colors duration-200 group'>
              <Linkedin size={24} className='text-primary-500 group-hover:text-white transition-colors duration-200' />
            </Button>
            <Button className='flex p-2 rounded-full bg-primary-500/25 hover:bg-primary-500/50 transition-colors duration-200 group'>
              <Phone size={24} className='text-primary-500 group-hover:text-white transition-colors duration-200' />
            </Button>
          </div>
        </div>
      </div>
